...
import { lastActivity, readActivityRound, salientToolArg } from '../src/client/sidechain/activity.ts'
...
describe('salientToolArg', () => {
  ...
  it('stringifies non-string values and malformed JSON input', () => {
...
describe('lastActivity', () => {
  ...
  it('prefers the latest assistant text over a newer tool call', () => {
    const rows = [
  ...
  it('returns undefined for an empty or failed-only window', () => {
