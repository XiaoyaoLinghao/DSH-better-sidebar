...
import type { SidebarState, SidebarStore, SidebarTab, TabComponentProps } from '../src/client/service.ts'
...
function catalog(entries: SidebarSubagentCatalog['entries']) {
  return { entries, parentAvailable: true, state: 'ready' as const, error: null }
}
...
describe('Sidechain descriptor factory', () => {
  it('defines the fixed metadata contract', () => {
    ...
    expect(descriptor.settings).toEqual({
      toggles: [{
