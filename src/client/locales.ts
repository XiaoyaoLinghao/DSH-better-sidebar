...
export const zh = {
  ...
  sidechain: '侧链',
  sidechainDescription: '在独立侧边会话中继续处理任务',
  autoOpenSidechain: '检测到侧链任务时自动打开',
  autoOpenSidechainDesc: '创建侧链会话时自动展开侧边栏并打开侧链页面；关闭后需手动打开',
  sidechainEmpty: '暂无侧链会话',
  sidechainLoading: '正在加载侧链会话…',
  sidechainError: '侧链会话加载失败',
  sidechainRetry: '重试侧链会话',
  sidechainBack: '返回侧链',
  sidechainRunning: '运行中',
  sidechainInactive: '未运行',
  sidechainOneShot: '一次性',
  sidechainContinuable: '可继续',
  sidechainReadOnly: '只读',
  sidechainPromptPlaceholder: '输入侧链提示…',
  sidechainSend: '发送',
  sidechainSending: '发送中…',
  sidechainPromptFailed: '提示发送失败',
  sidechainOpenFile: '打开文件',
  sidechainToolDetails: '工具详情',
  sidechainToolFailed: '工具调用失败',
  sidechainReasoning: '推理',
  sidechainContext: '上下文',
  sidechainRecall: '召回',
  sidechainDiagnosticCorrupt: '目录损坏',
  sidechainDiagnosticUnsupported: '不支持的条目',
  sidechainDiagnosticUnavailable: '不可用',
}
...
export const en: Record<keyof typeof zh, string> = {
  ...
  sidechain: 'Sidechain',
  sidechainDescription: 'Continue work in a dedicated side conversation',
  autoOpenSidechain: 'Auto-open sidechains',
  autoOpenSidechainDesc: 'Expand the sidebar and open the Sidechain page when a side conversation is created; turn off to open it manually',
  sidechainEmpty: 'No sidechain conversations',
  sidechainLoading: 'Loading sidechain conversation…',
  sidechainError: 'Failed to load sidechain conversation',
  sidechainRetry: 'Retry sidechain conversation',
  sidechainBack: 'Back to sidechain',
  sidechainRunning: 'Running',
  sidechainInactive: 'Inactive',
  sidechainOneShot: 'One-shot',
  sidechainContinuable: 'Continuable',
  sidechainReadOnly: 'Read-only',
  sidechainPromptPlaceholder: 'Enter a sidechain prompt…',
  sidechainSend: 'Send',
  sidechainSending: 'Sending…',
  sidechainPromptFailed: 'Failed to send prompt',
  sidechainOpenFile: 'Open file',
  sidechainToolDetails: 'Tool details',
  sidechainToolFailed: 'Tool call failed',
  sidechainReasoning: 'Reasoning',
  sidechainContext: 'Context',
  sidechainRecall: 'Recall',
  sidechainDiagnosticCorrupt: 'Corrupt',
  sidechainDiagnosticUnsupported: 'Unsupported',
  sidechainDiagnosticUnavailable: 'Unavailable',
}

const SIDECHAIN_LABEL_KEYS = [
  'sidechain',
...
/** Fixed copy surface consumed by native sidechain UI. */
export type SidechainLabels = Pick<Record<keyof typeof zh, string>, typeof SIDECHAIN_LABEL_KEYS[number]>

/** Return the fixed sidechain copy surface in the active locale. */
export function getSidechainLabels(): SidechainLabels {
  const dict = activeLocale().toLowerCase().startsWith('zh') ? zh : en
  return Object.fromEntries(SIDECHAIN_LABEL_KEYS.map(key => [key, dict[key]])) as SidechainLabels
}
